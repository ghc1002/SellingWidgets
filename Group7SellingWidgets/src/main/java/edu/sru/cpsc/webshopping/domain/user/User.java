...
public class User implements UserDetails {
	...
	@OneToMany(mappedBy="spamOwner")
	private Set<Message> SpambyOwner;
	@OneToMany(mappedBy="spamOwnerReceiver")
	private Set<Message> spambyReceiver;
	@OneToMany(mappedBy="trashOwner")
	private Set<Message> TrashbyOwner;
	@OneToMany(mappedBy="trashOwnerReceiver")
	private Set<Message> TrashbyReceiver;
	@OneToMany(mappedBy="myTrash")
	private Set<Message> Trash;
	@OneToMany(mappedBy="mySpam")
