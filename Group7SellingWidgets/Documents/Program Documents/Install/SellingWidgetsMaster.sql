...
CREATE TABLE `user` (
  ...
  CONSTRAINT `FKh4ud7jq3bnx4pbtkl1bp1pgba` FOREIGN KEY (`default_payment_details_id`) REFERENCES `payment_details` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
